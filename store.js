(()=>{
  ...
  const desktopHost=document.querySelector('.mc-head-contact');if(desktopHost)desktopHost.insertAdjacentHTML('beforeend',`<button class="mc-cart-trigger" type="button" data-cart-open aria-label="Open shopping cart">${cartIcon}<b data-cart-count>0</b></button>`);
