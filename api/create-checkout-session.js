...
module.exports=async function handler(req,res){
  ...
  try{
    ...
    const params=new URLSearchParams({mode:'payment',success_url:`${site}/order-success?session_id={CHECKOUT_SESSION_ID}`,cancel_url:`${site}/store?checkout=cancelled`,client_reference_id:order.id,'metadata[order_id]':order.id,billing_address_collection:'required','phone_number_collection[enabled]':'true',customer_creation:'always',submit_type:'pay'});
